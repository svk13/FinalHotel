...
public class ResultPanel extends JPanel {
	 ...
	 * Create the panel.
	 */
	public ResultPanel(final ArrayList<Hotel> hotelList1,
			final BookingInfo bookinginfo1) {
		...
		gbl_panel_2.rowHeights = new int[] { 15, 15, 15, 15, 15, 15, 20, 20,
		...
		chckbxNewCheckBox.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (chckbxNewCheckBox.isSelected()) {
					...
					panel_1.removeAll();
					panel_1.setPreferredSize(new Dimension(1000, (newList
							.size() * 240)));
		...
		String labels[] = { "Raða eftir", "A-Z", "Z-A", "Prices from",
				"Prices to" };
		...
		final JSpinner spinner = new JSpinner(new SpinnerNumberModel(1, 1, 30,
				1));
		...
		btnClearSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				newList = SearchControl.LeitaHotel("", dateInString,
						dateOutString);
				panel_1.removeAll();
				panel_1.setPreferredSize(new Dimension(1000,
						(newList.size() * 240)));
				panel_1.setLayout(new GridLayout(newList.size(), 1, 100, 0));
				updateUIid(newList);
